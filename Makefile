...
# the current full POT file list from the content of '50-pot/' dir
...
# the current full PO file list from the content of '[lang_code]/po/' dirs
OBSOLETE_PO_LIST := $(filter-out $(FULL_PO_LIST), $(wildcard */po/*.po))
# The current full image file list is generated by prefixing the lang code to 'FULL_IMAGE_LIST'. Obsolete image file list 
# is generated by filtering out the current full PO file list from the content of '[lang_code]/images/src/*/' dirs
