...
# it is generated a pattern like 'locale/lang/po/_DOMAIN_NAME_.lang.po', then the placeholder
# _DOMAIN_NAME_ is substituted with each available domain to get a pattern like
# 'locale/lang/po/domain.lang.po'
...
ifneq ($(strip $(CHECK_IF_TO_BE_TRANSLATED)),)
...
# selected domains, then it is added the prefix 'locale/lang/po/' as dir name.
